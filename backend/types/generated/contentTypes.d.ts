...
export interface ApiFooterFooter extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footer_btns: Schema.Attribute.Component<'footer.bottom-links', true>;
    footer_opt: Schema.Attribute.Component<'footer.optional-slots', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::footer.footer'
...
export interface ApiIceCreamIceCream extends Struct.CollectionTypeSchema {
  collectionName: 'ice-creams';
  info: {
    displayName: 'Ice-creams';
    pluralName: 'ice-creams';
    singularName: 'ice-cream';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    ingredient: Schema.Attribute.Component<'default.ingredient', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::ice-cream.ice-cream'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiMainBodyMainBody extends Struct.CollectionTypeSchema {
  collectionName: 'main-bodies';
  info: {
    displayName: 'Main Body';
    pluralName: 'main-bodies';
    singularName: 'main-body';
  };
  options: {
    draftAndPublish: false;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::main-body.main-body'
    > &
      Schema.Attribute.Private;
    mainPrimaryContent: Schema.Attribute.Component<
...
export interface ApiPortobelloPortobello extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'Portobellos';
    pluralName: 'portobellos';
    singularName: 'portobello';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    portobelloPrimary: Schema.Attribute.Component<
      ...
      false
    >;
    portobelloSecondary: Schema.Attribute.Component<
      'portobello.portobello-secondary',
      false
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiPromoSectionPromoSection
  extends Struct.CollectionTypeSchema {
  collectionName: 'promo-sections';
  info: {
    displayName: 'Promo Sections';
    pluralName: 'promo-sections';
    singularName: 'promo-section';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::promo-section.promo-section'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    row1: Schema.Attribute.String;
    row2: Schema.Attribute.String;
    row2Color: Schema.Attribute.String;
    row3: Schema.Attribute.String;
...
export interface ApiZariadeniaZariadenia extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'zariadenia';
    pluralName: 'zariadenias';
    singularName: 'zariadenia';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    units_part: Schema.Attribute.Component<'units.units', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
